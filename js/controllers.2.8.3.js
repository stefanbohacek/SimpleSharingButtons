    ...
    if (!$scope.facebook){
      ...
      switch($scope.style){
        case "font_awesome":
          switch ($scope.mode){
            case 'nojs':
              $scope.html += '  <li><a href="https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent($scope.url.trim()) + '&t=' +  encodeURIComponent($scope.title.trim()) +'" target="_blank" title="Share on Facebook"><i class="fa fa-facebook-square fa-2x"></i></a></li>\n';
            break;
            case 'js':
        ...
        case "font_awesome":
          switch ($scope.mode){
            case 'nojs':
              ...
              $scope.html += '" target="_blank" title="Tweet"><i class="fa fa-twitter-square fa-2x"></i></a></li>\n';
            break;
            case 'js':
              $scope.html += '  <li><a href="https://twitter.com/intent/tweet?source=' + encodeURIComponent($scope.url.trim()) + '&text='+ encodeURIComponent($scope.title.trim()) + ':%20' + encodeURIComponent($scope.url.trim());
              if ($scope.twitter_handle != ''){
              ...
              $scope.html += '" target="_blank" title="Tweet" onclick="window.open(\'https://twitter.com/intent/tweet?text=\' + encodeURIComponent(document.title) + \':%20\' + encodeURIComponent(document.URL)); return false;"><i class="fa fa-twitter-square fa-2x"></i></a></li>\n';
            break;
//            case 'php':
//            break;
          }
    ...
    if ($scope.google_plus){
      switch($scope.style){
        case "font_awesome":
          switch ($scope.mode){
            case 'nojs':
              $scope.html += '  <li><a href="https://plus.google.com/share?url=' + encodeURIComponent($scope.url.trim()) + '" target="_blank" title="Share on Google+"><i class="fa fa-google-plus-square fa-2x"></i></a></li>\n';
            break;
            case 'js':
              $scope.html += '  <li><a href="https://plus.google.com/share?url=' + encodeURIComponent($scope.url.trim()) + '" target="_blank" title="Share on Google+" onclick="window.open(\'https://plus.google.com/share?url=\' + encodeURIComponent(document.URL)); return false;"><i class="fa fa-google-plus-square fa-2x"></i></a></li>\n';
            break;
//            case 'php':
//            break;
          }
    ...
    if ($scope.tumblr){
      switch($scope.style){
        case "font_awesome":
          switch ($scope.mode){
            case 'nojs':
              $scope.html += '  <li><a href="http://www.tumblr.com/share?v=3&u=' + encodeURIComponent($scope.url.trim()) + '&t=' + encodeURIComponent($scope.title.trim()) + '&s=" target="_blank" title="Post to Tumblr"><i class="fa fa-tumblr-square fa-2x"></i></a></li>\n';
            break;
            case 'js':
        ...
        case "font_awesome":
          switch ($scope.mode){
            case 'nojs':
              ...
              $scope.html += '&description=' + encodeURIComponent($scope.description.trim()) + '" target="_blank" title="Pin it"><i class="fa fa-pinterest-square fa-2x"></i></a></li>\n';
            break;
            case 'js':
              $scope.html += '  <li><a href="http://pinterest.com/pin/create/button/?url=' + encodeURIComponent($scope.url.trim());
              $scope.html += '&description=' + encodeURIComponent($scope.description.trim()) + '" target="_blank" title="Pin it" onclick="window.open(\'http://pinterest.com/pin/create/button/?url=\' + encodeURIComponent(document.URL) + \'&description=\' +  encodeURIComponent(document.title)); return false;"><i class="fa fa-pinterest-square fa-2x"></i></a></li>\n';
            break;
//            case 'php':
//            break;
          }
...
//            break;
          ...
          $scope.html += '  <li><a href="https://getpocket.com/save?url=' + encodeURIComponent($scope.url.trim()) + '&title=' + encodeURIComponent($scope.title.trim()) + '" target="_blank" title="Add to Pocket"><i class="fa fa-pocket-square fa-2x"></i></a></li>\n';
        */
        break;
        case "none":
          switch ($scope.mode){
    ...
    if ($scope.reddit){
      switch($scope.style){
        case "font_awesome":
          switch ($scope.mode){
            case 'nojs':
              $scope.html += '  <li><a href="http://www.reddit.com/submit?url=' + encodeURIComponent($scope.url.trim()) + '&title=' + encodeURIComponent($scope.title.trim()) + '" target="_blank" title="Submit to Reddit"><i class="fa fa-reddit-square fa-2x"></i></a></li>\n';
            break;
            case 'js':
        ...
        case "font_awesome":
          switch ($scope.mode){
            case 'nojs':
              ...
              $scope.html += '" target="_blank" title="Publish on WordPress"><i class="fa fa-wordpress fa-2x"></i></a></li>\n';
            break;
            case 'js':
              $scope.html += '  <li><a href="http://wordpress.com/press-this.php?u=' + encodeURIComponent($scope.url.trim()) + '&t=' + encodeURIComponent($scope.title.trim()) + '&s=' + encodeURIComponent($scope.description.trim());
              $scope.html += '" target="_blank" title="Publish on WordPress" onclick="window.open(\'http://wordpress.com/press-this.php?u=\' + encodeURIComponent(document.URL) + \'&t=\' +  encodeURIComponent(document.title)); return false;"><i class="fa fa-wordpress fa-2x"></i></a></li>\n';
            break;
//            case 'php':
//            break;
          }       
      ...
      switch($scope.style){
        case "font_awesome":
          switch ($scope.mode){
            case 'nojs':
              /* NOT SUPPORTED
                $scope.html += '  <li><a href="https://pinboard.in/popup_login/?url=' + encodeURIComponent($scope.url.trim()) + '&title=' + encodeURIComponent($scope.title.trim()) + '&description=' + encodeURIComponent($scope.description.trim()) + '" target="_blank" title="Save to Pinboard"><i class="fa fa-pinboard-square fa-2x"></i></a></li>\n';
              */
            break;
            case 'js':
    ...
    if ($scope.email){
      switch($scope.style){
        case "font_awesome":
          switch ($scope.mode){
            case 'nojs':
              $scope.html += '  <li><a href="mailto:?subject=' + encodeURIComponent($scope.title.trim()) + '&body=' + encodeURIComponent($scope.description.trim()) + ':%20' + encodeURIComponent($scope.url.trim()) + '" target="_blank" title="Email"><i class="fa fa-envelope-square fa-2x"></i></a></li>\n';
            break;
            case 'js':
              $scope.html += '  <li><a href="mailto:?subject=' + encodeURIComponent($scope.title.trim()) + '&body=' + encodeURIComponent($scope.description.trim()) + ':%20' + encodeURIComponent($scope.url.trim()) + '" target="_blank" title="Email" onclick="window.open(\'mailto:?subject=\' + encodeURIComponent(document.title) + \'&body=\' +  encodeURIComponent(document.URL)); return false;"><i class="fa fa-envelope-square fa-2x"></i></a></li>\n';
            break;
//            case 'php':
//            break;
          }
        ...
        case "none":
          switch ($scope.mode){
            case 'nojs':
              $scope.html += '  <li><a href="mailto:?subject=' + encodeURIComponent($scope.title.trim()) + '&body=' + encodeURIComponent($scope.description.trim()) + ':%20' + encodeURIComponent($scope.url.trim()) + '" target="_blank" title="Email">Email</a></li>\n';
            break;
            case 'js':
